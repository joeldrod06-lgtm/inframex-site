  ...
  return (
    <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl font-light text-gray-900 mb-4">Solicite una cotización</h2>
        ...
        <p className="text-xs text-gray-400 mt-6">
          o contáctanos directamente por <a href="https://wa.me/5210000000000" className="text-gray-600 underline">WhatsApp</a>
        </p>
      </div>
    </div>
  );
